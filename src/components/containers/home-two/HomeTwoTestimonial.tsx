                    ...
                    <div className="testimonial-two__slider-single">
                      <div className="paragraph">
                        <blockquote className="secondary-text">
                          <q>
                            Welcome to our Media Services. We specialize in
                  ...
                  <SwiperSlide>
                    <div className="testimonial-two__slider-single">
                      <div className="paragraph">
                        <blockquote className="secondary-text">
                          <q>
                            Welcome to our Media Services. We bring creativity and precision together effortlessly.
                          </q>
                        </blockquote>
                      </div>
                      <div className="author-meta">
                  ...
                  <SwiperSlide>
                    <div className="testimonial-two__slider-single">
                      <div className="paragraph">
                        <blockquote className="secondary-text">
                          <q>
                            Welcome to our Media Services. We make every project look premium and impactful
                          </q>
                        </blockquote>
                      </div>
                      <div className="author-meta">
